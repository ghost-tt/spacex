...
class AppSubmenu extends Component {
	...
	renderLink(item, i) {
		...
		if (item.to) {
			...
			return (
				<a href={item.url} onClick={(e) => this.onMenuItemClick(e, item, i)} target={item.target} rel="noopener noreferrer"> 
					{content}
				</a>
			);
...
export class AppMenu extends Component {
    ...
    static defaultProps = {
        model: [{ label: 'Login to continue', icon: 'pi pi-fw pi-caret-left' }] ,
        onMenuItemClick: null
    }
